...
# 
# setwd("day01_02")
# babynames <- readr::read_csv("babynames.csv", n_max = 10)
# setwd("/cloud/project")
...
Let's learn a little bit on how to *Tranform* our data. Also referred to as data munging/preppying/tidying. 
...
```{r}
wages <- read_csv("wages.csv", na = c("","  ","NA"))
